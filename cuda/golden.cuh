...
__global__ void _fps1(triangle* triangles, size_t num_triangles, layer_t* all_intersections, unsigned* trunk_length);
__global__ void _fps2(layer_t* all_intersections, unsigned* trunk_length);
__global__ void _fps3(layer_t* sorted_intersections, unsigned* trunk_length, bool* out);
